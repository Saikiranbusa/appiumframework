...
public class testcase1  extends framework {
	...
	public void tc1() throws IOException, InterruptedException {
		...
		driver.findElement(MobileBy.id("com.androidsample.generalstore:id/nameField")).sendKeys("kiran");
